...
namespace Asgla.Window {
    public abstract class ItemListMain : UIWindow {
        ...
        [SerializeField] protected Transform _all = null;
        [SerializeField] protected Transform _class = null;
        [SerializeField] protected Transform _armor = null;
        [SerializeField] protected Transform _weapon = null;
        [SerializeField] protected Transform _helm = null;

        [SerializeField] private ItemSlot _slot = null;
        ...
        protected void Order() {
            int i = 0;
            foreach (ItemSlot slot in from s in _slots orderby s.Item().Type.Category ascending select s) {
