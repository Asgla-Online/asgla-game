...
namespace Asgla.Avatar {
    public abstract class AvatarMain : MonoBehaviour, IAvatar {
        ...
        public void PopupText(string value, SkillDamageType type) {
            ...
            Vector3 vector3 = new Vector3 { x = transform.position.x, y = transform.position.y + 2f, z = transform.position.z };

            PopupText popupText = Instantiate(popupTextObj, vector3, Quaternion.identity, transform).GetComponent<PopupText>();
        ...
        public virtual void Area(MapArea area) => _area = area;
        ...
        public virtual void Position(Vector2 vector2) => _position = vector2;
        ...
        public virtual void PlayAnimation(bool play) => Animator().speed = play ? 1 : 0;
        ...
        public virtual AvatarStats Stats() => _stats;

        public abstract AvatarState State();

        public abstract EntityType Type();

        public virtual MapArea Area() => _area;

        public virtual Vector2 Position() => transform.position;

        public virtual float Scale() => _animator.transform.localScale.x;

        public virtual GameObject Avatar() => gameObject;

        public virtual Animator Animator() => _animator;

        public virtual Rigidbody2D Body() => _rigidBody2D;

        public AvatarUtility Utility() => _utility;
