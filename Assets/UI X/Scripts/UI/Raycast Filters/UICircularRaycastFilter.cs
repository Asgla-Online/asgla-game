...
namespace AsglaUI.UI {
	...
	public class UICircularRaycastFilter : MonoBehaviour, ICanvasRaycastFilter {
		...
		[Range(0f, 100f)] [SerializeField] private float m_Radius = 70f;
		...
		public bool radiusInPercents {
			get => m_RadiusInPercents;
			set => m_RadiusInPercents = value;
		}
		...
		public float operationalRadius => m_RadiusInPercents ? rectMaxRadius * (m_Radius / 100f) : m_Radius;
		...
		public bool IsRaycastLocationValid(Vector2 screenPoint, Camera eventCamera) {
			...
			return Vector2.Distance(localPosition, center) <= operationalRadius;
		}
