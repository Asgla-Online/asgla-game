...
namespace AsglaUI.UI {
	...
	public class UIMaskRaycastFilter : MonoBehaviour, ICanvasRaycastFilter {
		...
		[SerializeField] [Range(0f, 1f)] private float m_AlphaTreshold = 0.01f;
		...
		protected void Awake() {
			...
			if (m_Image != null) m_Sprite = m_Image.sprite;
		}
		...
		protected void OnValidate() {
			...
			if (m_Sprite != null) {
				string path = AssetDatabase.GetAssetPath(m_Sprite.texture);
