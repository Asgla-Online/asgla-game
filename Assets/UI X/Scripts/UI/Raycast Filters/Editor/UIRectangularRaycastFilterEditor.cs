...
namespace AsglaUIEditor.UI {
	...
	public class UIRectangularRaycastFilterEditor : Editor {
		...
		public Vector3[] scaledWorldCorners {
			get{
				UIRectangularRaycastFilter filter = target as UIRectangularRaycastFilter;
				...
				corners[1] = new Vector3(rt.rect.x + scaledRect.x,
					rt.rect.height + rt.rect.y + scaledRect.y + scaledRect.height, 0f);
				corners[2] = new Vector3(rt.rect.x + scaledRect.x + scaledRect.width,
					rt.rect.height + rt.rect.y + scaledRect.y + scaledRect.height, 0f);
				corners[3] = new Vector3(rt.rect.x + scaledRect.x + scaledRect.width,
					rt.rect.height + rt.rect.y + scaledRect.y, 0f);
		...
		protected void OnSceneGUI() {
			...
			Vector3[] worldCorners = scaledWorldCorners;
