...
{
	[CanEditMultipleObjects, CustomEditor(typeof(AsglaUI.UI.UIWindow))]
	public class UIWindowEditor : Editor {
        ...
        protected void DrawTransitionProperties()
		{
            ...
            // Get the transition
            AsglaUI.UI.UIWindow.Transition transition = (AsglaUI.UI.UIWindow.Transition)this.m_TransitionProperty.enumValueIndex;
			
			if (transition == AsglaUI.UI.UIWindow.Transition.Fade)
			{
				EditorGUI.indentLevel = (EditorGUI.indentLevel + 1);
