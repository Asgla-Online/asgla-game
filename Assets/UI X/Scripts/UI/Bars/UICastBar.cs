...
namespace AsglaUI.UI {
    ...
    public class UICastBar : MonoBehaviour {
        ...
        public virtual void StartCasting(SkillData skillData, float duration, float endTime, string target, string targets) {
            ...
            // Set the spell name
            if (this.m_TitleLabel != null)
                this.m_TitleLabel.text = skillData.Name;

            // Set the full time cast text
            if (this.m_FullTimeLabel != null)
                this.m_FullTimeLabel.text = skillData.CastTime.ToString(this.m_FullTimeFormat);
            ...
            if (this.m_UseSpellIcon) {
                ...
                if (skillData.Icon != null) {
                    ...
                    if (this.m_IconImage != null)
                        this.m_IconImage.sprite = skillData.GetIcon;
