...
namespace AsglaUI.UI {
	...
	public class AnimationTriggersExtended {
		...
		public string highlightedTrigger {
			get => m_HighlightedTrigger;
			set => m_HighlightedTrigger = value;
		}

		public string pressedTrigger {
			get => m_PressedTrigger;
			set => m_PressedTrigger = value;
		}

		public string activeTrigger {
			get => m_ActiveTrigger;
			set => m_ActiveTrigger = value;
		}

		public string activeHighlightedTrigger {
			get => m_ActiveHighlightedTrigger;
			set => m_ActiveHighlightedTrigger = value;
		}

		public string activePressedTrigger {
			get => m_ActivePressedTrigger;
			set => m_ActivePressedTrigger = value;
		}

		public string disabledTrigger {
			get => m_DisabledTrigger;
