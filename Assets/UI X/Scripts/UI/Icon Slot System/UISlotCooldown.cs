...
namespace AsglaUI.UI {
    ...
    public class UISlotCooldown : MonoBehaviour {
        ...
        private static Dictionary<int, CooldownInfo> skillCooldowns = new Dictionary<int, CooldownInfo>();
        ...
        private int m_CurrentSkillId = 0;
        ...
        public Dictionary<int, CooldownInfo> Cooldowns() => skillCooldowns;

        /// <summary>
        /// Raises the assign spell event.
        /// </summary>
        public void OnAssignSpell() => this.CheckForActiveCooldown();

        /// <summary>
        /// Raises the unassign event.
        /// </summary>
        public void OnUnassignSpell() => this.InterruptCooldown();
        ...
        public void CheckForActiveCooldown() {
            ...
            // Get the spell info
            SkillData spellInfo = this.m_CooldownSlot.GetSkillData();
            ...
            if (skillCooldowns.ContainsKey(spellInfo.DatabaseID)) {
                ...
                if (cooldownTill > Time.time) {
                    ...
                    // Resume the cooldown
                    this.ResumeCooldown(spellInfo.DatabaseID);
                } else {
        ...
        public void StartCooldownCoroutine(CooldownInfo info) {
            this.StartCoroutine("_StartCooldown", info);
        }
        ...
        private void OnCooldownCompleted() {
            ...
            if (skillCooldowns.ContainsKey(this.m_CurrentSkillId))
                skillCooldowns.Remove(this.m_CurrentSkillId);
