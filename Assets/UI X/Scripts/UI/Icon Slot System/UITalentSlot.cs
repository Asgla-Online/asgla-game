	...
	public class UITalentSlot : UISlotBase {
		...
		public void UpdatePointsLabel() {
			...
			if (this.m_CurrentPoints == 0) {
				this.m_PointsText.text += "<color=#" + CommonColorBuffer.ColorToString(this.m_pointsMinColor) + ">" +
				                          this.m_CurrentPoints.ToString() + "</color>";
				this.m_PointsText.text += "<color=#" + CommonColorBuffer.ColorToString(this.m_pointsMaxColor) + ">/" +
		...
		public override void OnTooltip(bool show) {
			...
			if (show) {
				...
				SkillMain.PrepareTooltip(this.m_SpellInfo);
