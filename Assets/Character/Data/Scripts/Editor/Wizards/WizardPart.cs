    ...
    public class WizardPart : ScriptableWizard {
        ...
        protected override bool DrawWizardGUI() {
            ...
            if (_templates[_stemp] is WeaponTemplate) {
                ...
                if (t.weaponCategory == Asgla.Data.Type.Weapon.Gun) {
                ...
                } else if (t.weaponCategory == Asgla.Data.Type.Weapon.Rifle) {
                    EditorGUILayout.LabelField("Muzzle Flash", WizardUtils.BoldTextStyle);
        ...
        protected void createPart() {
            try {
                ...
                if (_templates[_stemp] is WeaponTemplate) {
                    ...
                    //filename = WizardUtils.PartFolder + "/" + (_packstring[_spack] + "/Weapon/" + getDirectoryName(twtemplate.weaponCategory) + "/" + _partname + ".asset").ToLower();
                    filename = WizardUtils.PartFolder + "/weapon/" + (getDirectoryName(twtemplate.weaponCategory) + "/" + _partname + "/" + _partname + ".asset").ToLower();
                } else {
                    //filename = WizardUtils.PartFolder + "/" + (_packstring[_spack] + "/" + getDirectoryName(_templates[_stemp].category) + "/" + _partname + ".asset").ToLower();
                    filename = WizardUtils.PartFolder + "/" + (getDirectoryName(_templates[_stemp].category) + "/" + _partname + "/" + _partname + ".asset").ToLower();
                }
                ...
                //..sprites
                if (_texture != null && _templates[_stemp].category != Category.SkinDetail) //..skin details doesn't need to be sliced
                {
        ...
        private string getDirectoryName(Category partCategory) {
            switch (partCategory) {
        ...
        private string getDirectoryName(Asgla.Data.Type.Weapon weaponCategory) {
            switch (weaponCategory) {
                case Asgla.Data.Type.Weapon.OneHanded:
                    return "One Handed";
                case Asgla.Data.Type.Weapon.TwoHanded:
                    return "Two Handed";
                default:
