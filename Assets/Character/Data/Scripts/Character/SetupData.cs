...
namespace CharacterCreator2D {
    public class SetupData : ScriptableObject {
        ...
        /// </summary>
        public static readonly Dictionary<Equipment, Dictionary<string, string>> partLinks = new Dictionary<Equipment, Dictionary<string, string>>()
        {
            {
                Equipment.Armor,
                new Dictionary<string, string>()
                {
                    ...
                    //Foot right front - Pé direito frente
                    ...
                    { "Pants Back",         "Root/Pos_Hip/Bone_Hip/Hip/Pants Back" },
        ...
        public static readonly Dictionary<Equipment, List<string>> colorableSpriteLinks = new Dictionary<Equipment, List<string>>()
        {
            {
                Equipment.Eyebrow,
                new List<string>()
        ...
        public static readonly Dictionary<Equipment, string> weaponFXLinks = new Dictionary<Equipment, string>()
        {
            { Equipment.MainHand, "Root/FX/Weapon Slash R" },
            { Equipment.OffHand, "Root/FX/Weapon Slash L" }
        };

        public static readonly Dictionary<Equipment, string> muzzleFXLinks = new Dictionary<Equipment, string>()
        {
            { Equipment.MainHand, "Root/Pos_Hip/Bone_Hip/Pos_Body/Bone_Body/Pos_Upper Arm R/Bone_Upper Arm R/Pos_Lower Arm R/Bone_Lower Arm R/Pos_Hand R/Bone_Hand R/Pos_Weapon R/Bone_Weapon R/Muzzle R" },
            { Equipment.OffHand, "Root/Pos_Hip/Bone_Hip/Pos_Body/Bone_Body/Pos_Upper Arm L/Bone_Upper Arm L/Pos_Lower Arm L/Bone_Lower Arm L/Pos_Hand L/Bone_Hand L/Pos_Weapon L/Bone_Weapon L/Muzzle L" }
        };
