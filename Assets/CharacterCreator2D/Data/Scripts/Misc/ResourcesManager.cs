...
namespace CharacterCreator2D {
	...
	public static class ResourcesManager {
        ...
        private static readonly Dictionary<Object, HashSet<Func<Object>>> m_resGetterDict =
 new Dictionary<Object, HashSet<Func<Object>>>();
#endif
		...
		/// &#xD;&#xD;See also : <seealso cref="RegisterReference{T}(T, System.Func{T})"/>, <seealso cref="ReleaseZeroReference()"/>
		/// </summary>
		...
		public static void ReleaseZeroReference() {
            ...
            {
                isUnload = false;
                Dictionary<Object, HashSet<Func<Object>>> resGetterDictCopy =
 new Dictionary<Object, HashSet<Func<Object>>>(m_resGetterDict);
