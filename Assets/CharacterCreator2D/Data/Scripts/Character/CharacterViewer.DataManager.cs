	...
	public partial class CharacterViewer {
		...
		public class DataManager {
			...
			public bool SetEmotion(CharacterViewer character, EmoteIndexData edata) {
				...
				targetEmoteIndex.eyebrowPart =
					PartList.Static.FindPart(edata.eyebrowPartName, edata.eyebrowPackage, SlotCategory.Eyebrow);
				targetEmoteIndex.eyesPart =
					PartList.Static.FindPart(edata.eyesPartName, edata.eyesPackage, SlotCategory.Eyes);
				targetEmoteIndex.nosePart =
					PartList.Static.FindPart(edata.nosePartName, edata.nosePackage, SlotCategory.Nose);
				targetEmoteIndex.mouthPart =
					PartList.Static.FindPart(edata.mouthPartName, edata.mouthPackage, SlotCategory.Mouth);
				targetEmoteIndex.earPart =
					PartList.Static.FindPart(edata.earPartName, edata.earPackage, SlotCategory.Ear);
				return true;
			}
