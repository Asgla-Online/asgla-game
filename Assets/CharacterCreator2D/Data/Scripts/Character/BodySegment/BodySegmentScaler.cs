...
namespace CharacterCreator2D {
	...
	public class BodySegmentScaler {
		...
		[NonSerialized] private Dictionary<string, PositionedAffection> _posaffections;

		[NonSerialized] private Dictionary<SegmentType, ScaledAffection> _scaledaffections;

		[NonSerialized] private Dictionary<SegmentType, SegmentData> _segmentdatas;
