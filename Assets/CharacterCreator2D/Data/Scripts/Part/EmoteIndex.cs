		...
		public void setPart(SlotCategory slot, Part part) {
			switch (slot) {
				case (SlotCategory.Eyebrow):
					this.eyebrowPart = part == null ? null : part;
					break;
				case (SlotCategory.Eyes):
					this.eyesPart = part == null ? null : part;
					break;
				case (SlotCategory.Nose):
					this.nosePart = part == null ? null : part;
					break;
				case (SlotCategory.Mouth):
					this.mouthPart = part == null ? null : part;
					break;
				case (SlotCategory.Ear):
					this.earPart = part == null ? null : part;
					break;
			}
		}
