...
namespace CharacterCreator2D {
	public class Part : ScriptableObject {
		...
		/// Part's package name.
		/// </summary>
		[Tooltip("Part's package name")] public string packageName;

		/// <summary>
		/// Part's category.
		/// </summary>
		[Tooltip("Part's category")] public PartCategory category;
		...
		/// Part's main texture.
		/// </summary>
		[Tooltip("Part's main texture")] public Texture2D texture;

		/// <summary>
		/// Part's color mask.
		/// </summary>
		[Tooltip("Part's color mask")] public Texture2D colorMask;
