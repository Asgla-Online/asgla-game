...
namespace CharacterCreator2D.Utilities {
	public static class RendererUtility {
		...
		public static bool AssignTexture(this Transform parentTransform,
		...
		public static bool AssignColor(this Transform transform,
			string transformPath,
			Color color,
			bool isShared = true) {
		...
		public static void AssignSprites(this Transform parentTransform,
		...
		public static void AssignSpriteColors(this Transform parentTransform,
		...
		public static bool AssignMaterial(this Transform parentTransform,
			string transformPath,
			Material material,
			bool isShared = true) {
			if (!GetRenderer(parentTransform, transformPath, out Renderer renderer)) {
		...
		public static void AssignMaterials(this Transform parentTransform,
			IEnumerable<string> transformPaths,
			Material material,
			bool isShared = true) {
			if (transformPaths == null) {
		...
		public static bool GetRenderer<T>(this Transform parentTransform, string transformPath, out T result)
			where T : Renderer {
			result = null;
		...
		public static bool GetTransformAtPath(this Transform parentTransform,
			string transformPath,
		...
		public static void ClearTexture(this RenderTexture renderTexture,
			bool clearDepth,
			bool clearColor,
		...
		public static void ReadTexture(this RenderTexture renderTexture,
		...
		private static void ReadTextureInternal(RenderTexture renderTexture,
			Texture sourceTexture,
			Material material,
			Rect sourceRect,
			Rect targetRect) {
