...
namespace CharacterCreator2D.Utilities.Humanoid {
	...
	public class HumanoidManager : CharacterManager {
		...
		[SerializeField] private HumanoidSetter m_setter = new HumanoidSetter();

		[SerializeField] private HumanoidAssigner m_assigner = new HumanoidAssigner();

		[SerializeField] private HumanoidBaker m_baker = new HumanoidBaker();
