...
namespace CharacterCreator2D.Utilities.Humanoid {
	public static class HumanoidUtility {
		...
		public static void AssignWeaponSprites(this Transform transform,
		...
		public static void AssignMainHandSprites(this Transform transform,
			WeaponCategory weaponCategory,
			IEnumerable<Sprite> sprites) {
		...
		public static void AssignOffHandSprites(this Transform transform,
			WeaponCategory weaponCategory,
			IEnumerable<Sprite> sprites) {
			switch (weaponCategory) {
				case WeaponCategory.OneHanded:
		...
		public static void AssignClothTexture(this Transform transform,
		...
		public static void AssignSlotSprites(this Transform transform,
			SlotCategory category,
			IEnumerable<Sprite> sprites) {
		...
		public static void AssignSlotMaterial(this Transform transform,
			SlotCategory slotCategory,
			Material material,
			bool isShared) {
			switch (slotCategory) {
		...
		public static void AssignSlotMainColor(this Transform transform,
			SlotCategory slotCategory,
			Color color,
			bool isShared = true) {
			switch (slotCategory) {
