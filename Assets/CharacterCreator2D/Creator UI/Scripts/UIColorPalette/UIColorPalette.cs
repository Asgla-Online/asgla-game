...
namespace CharacterCreator2D.UI {
	public class UIColorPalette : MonoBehaviour {
		...
		/// </summary>
		[Tooltip("PackageItem's template")] public PackageItem tPackageItem;

		/// <summary>
		/// PaletteItem's template.
		/// </summary>
		[Tooltip("PaletteItem's template")] public PaletteItem tPaletteItem;
		...
		/// </summary>
		[Tooltip("Current color selected by this UIColorPalette")] [ReadOnly]
