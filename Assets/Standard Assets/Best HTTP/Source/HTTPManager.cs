...
namespace BestHTTP {
	...
	public delegate SecureProtocol.Org.BouncyCastle.Crypto.Tls.AbstractTlsClient TlsClientFactoryDelegate(
		HTTPRequest request,
...
//            IOService = new PlatformSupport.FileSystem.WebGLIOService();
		...
		public static SecureProtocol.Org.BouncyCastle.Crypto.Tls.AbstractTlsClient DefaultTlsClientFactory(
			HTTPRequest request,
			List<string> protocols) {
			...
			return new SecureProtocol.Org.BouncyCastle.Crypto.Tls.LegacyTlsClient(request.CurrentUri,
				request.CustomCertificateVerifyer == null
					? new SecureProtocol.Org.BouncyCastle.Crypto.Tls.AlwaysValidVerifyer()
					: request.CustomCertificateVerifyer,
		...
		/// </summary>
		public static SecureProtocol.Org.BouncyCastle.Crypto.Tls.ICertificateVerifyer DefaultCertificateVerifyer {
			get;
			set;
		}
		...
		/// </summary>
		public static SecureProtocol.Org.BouncyCastle.Crypto.Tls.IClientCredentialsProvider
			DefaultClientCredentialsProvider { get; set; }
...
#if !NETFX_CORE
		public static
			Func<HTTPRequest, System.Security.Cryptography.X509Certificates.X509Certificate,
				System.Security.Cryptography.X509Certificates.X509Chain, bool> DefaultCertificationValidator {
			get;
			set;
		}
#endif
		...
		public static HTTPRequest SendRequest(string url,
