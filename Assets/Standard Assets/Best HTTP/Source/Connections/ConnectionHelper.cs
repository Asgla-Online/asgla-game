...
namespace BestHTTP.Connections {
	...
	public static class ConnectionHelper {
		...
		public static void HandleResponse(string context,
			HTTPRequest request,
			out bool resendRequest,
			out HTTPConnectionStates proposedConnectionState,
			ref KeepAliveHeader keepAlive,
			LoggingContext loggingContext1 = null,
			LoggingContext loggingContext2 = null,
...
#if !BESTHTTP_DISABLE_CACHING
		public static bool LoadFromCache(string context,
			HTTPRequest request,
			LoggingContext loggingContext1 = null,
			LoggingContext loggingContext2 = null,
			LoggingContext loggingContext3 = null) {
		...
		private static bool LoadFromCache(string context,
			HTTPRequest request,
			Uri uri,
			LoggingContext loggingContext1 = null,
			LoggingContext loggingContext2 = null,
		...
		public static bool TryLoadAllFromCache(string context,
			HTTPRequest request,
			LoggingContext loggingContext1 = null,
			LoggingContext loggingContext2 = null,
			LoggingContext loggingContext3 = null) {
			...
			try {
				...
				if (HTTPManager.Logger.Level == Logger.Loglevels.All)
					HTTPManager.Logger.Verbose("ConnectionHelper",
						string.Format("[{0}] - TryLoadAllFromCache - whole response loading from cache", context),
						loggingContext1, loggingContext2, loggingContext3);
				...
				HTTPManager.Logger.Verbose("ConnectionHelper",
					string.Format("[{0}] - TryLoadAllFromCache - failed to load content!", context), loggingContext1,
					loggingContext2, loggingContext3);
